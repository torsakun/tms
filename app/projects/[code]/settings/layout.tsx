...
const TABS = [
  ...
  { label: "Access control", href: (c: string) => `/projects/${c}/settings/access-control` },
  { label: "Members",        href: (c: string) => `/projects/${c}/settings/members` },
  { label: "Integrations",   href: (c: string) => `/projects/${c}/settings/integrations` },
];
  ...
  return (
    <div className="min-h-screen bg-surface">
      <div className="max-w-4xl mx-auto px-8 pt-10 pb-16">
        <h1 className="text-3xl font-bold text-text-main mb-8 tracking-tight">Project settings</h1>

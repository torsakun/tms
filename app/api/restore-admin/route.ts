...
export async function GET(req: Request) {
  ...
  try {
    ...
    await prisma.user.upsert({
      ...
      create: { email: 'supat.tor@gmail.com', passwordHash, name: 'Supat T', role: 'ADMIN' }
    });

    return NextResponse.json({ success: true, message: "Admin users created/updated successfully!" });
  } catch (err: any) {

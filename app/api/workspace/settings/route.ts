...
export async function GET(req: Request) {
  try {
    ...
    if (maskedConfig.OPENAI_API_KEY)
      maskedConfig.OPENAI_API_KEY =
        "••••••••••••••••••••••••••••" + maskedConfig.OPENAI_API_KEY.slice(-4);
    if (maskedConfig.GEMINI_API_KEY)
      maskedConfig.GEMINI_API_KEY =
        "••••••••••••••••••••••••••••" + maskedConfig.GEMINI_API_KEY.slice(-4);
    if (maskedConfig.CLAUDE_API_KEY)
      maskedConfig.CLAUDE_API_KEY =
        "••••••••••••••••••••••••••••" + maskedConfig.CLAUDE_API_KEY.slice(-4);
    if (maskedConfig.JIRA_API_TOKEN)
      maskedConfig.JIRA_API_TOKEN =
        "••••••••••••••••••••••••••••" + maskedConfig.JIRA_API_TOKEN.slice(-4);

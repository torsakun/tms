      ...
      <div className="relative" ref={menuRef}>
        <button
          ...
          className={`p-1.5 rounded-md transition-colors ${
            isOpen ? "bg-slate-200 text-slate-800" : "text-slate-400 hover:text-slate-600 hover:bg-slate-100"
          }`}
        >
      ...
      {showRoleModal && (
        <div className="fixed inset-0 bg-black/40 z-[100] flex items-center justify-center">
          <div className="bg-white rounded-xl shadow-xl w-full max-w-md p-6">
            <h3 className="text-lg font-semibold text-slate-800 mb-4">Edit User Role</h3>
            ...
            <div className="mb-6 relative">
              ...
              <div className="relative">
                <select
                  ...
                  className="w-full appearance-none bg-white border border-slate-300 text-slate-700 py-2.5 px-3 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 text-sm"
                >

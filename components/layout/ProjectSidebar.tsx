            ...
            {(role === 'ADMIN' || isSystemAdmin) && (
              <>
                ...
                <li>
                  ...
                  >
                    <Activity size={16} className={cn("mr-3", pathname.startsWith(`/projects/${projectCode}/activity`) ? "text-blue-400 drop-shadow-[0_0_8px_rgba(96,165,250,0.5)]" : "text-slate-500 group-hover:text-slate-300")} />
                    Audit Logs
                  </Link>
                </li>
              </>
